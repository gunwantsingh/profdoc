# WORKING FEDMEDIAN SCRIPT :)))
# need to modify the aggregation step to calculate the median of the encrypted model weights instead of averaging them.
# This modification calculates the median of the model weights for each feature across all clients and then encrypts the median weights before updating the global model.
