...
def fault_tolerant_median_encrypted_models(context, encrypted_models):
    ...
    if loaded_dataset is not None:
        ...
        for round_num in range(FL_rounds):
            ...
            for epoch_num in range(30):
                ...
                median_model = fault_tolerant_median_encrypted_models(context, local_models)
...
metrics_df.to_csv('FedYogi_HEOnly_metrics.csv', index=False)
