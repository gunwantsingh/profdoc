# Same as 2: This script contains HE + FL + BotNetIoT + Measures of Privacy Guarantees - It gives epsilon values (see PPT for details)
# It has a method now, for computing privacy
# this is final one for next steps.
...
try:
    ...
    if loaded_dataset is not None:
        ...
        for round_num in range(FL_rounds):
            ...
            # Compute privacy
            epsilon = compute_privacy(train_data, len(train_data), batch_size=256, noise_multiplier=0.6, epochs=2)
