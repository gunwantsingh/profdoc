...
file_name = "FedProx_SMPC_metrics.csv"
...
def secure_aggregation(weights):
    try:
        ...
        # Homomorphically encrypt shares using TenSEAL (or similar library)
        encrypted_shares = []
        for share in shares:
            # Perform homomorphic encryption here
            encrypted_shares.append(share)  # Placeholder for actual encryption
