        ...
        for round_num in range(FL_rounds):
            ...
            for epoch_num in range(30):
                ...
                for i in range(clients):
                    ...
                    # Update global model using FedAvgM with momentum
                    global_model = momentum * global_model + (1 - momentum) * local_model_weights
...
metrics_df.to_csv('FedAvgM_Simply_metrics.csv', index=False)
