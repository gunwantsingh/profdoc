...
fl_round_time_columns = [col for col in df.columns if 'Accuracy' in col]
...
if fl_round_time_columns:
    ...
    print(f"No columns with 'FL Accuracy' found in {csv_file}.")
