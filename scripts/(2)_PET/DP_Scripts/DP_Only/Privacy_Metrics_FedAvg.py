# This script only has HE + FL (FedAvg) with BotNetIoT.csv
# Next -> FedAvg - HE + FL - Meauring Privacy metrics through epsilon and delta.
...
output_size = 1
learning_rate = 0.1
FL_rounds = 3  # Number of Federated Learning rounds
...
try:
    ...
    if loaded_dataset is not None:
        ...
        for round_num in range(FL_rounds):
            ...
            print("Global Model Weights:", global_model_updated.get_weights())
